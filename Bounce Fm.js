...
let All_song = [
    {
        name: "Twlight",
        path: "Audio/Twilight_-_Maze_feat_Frankie_Beverl_(getmp3.pro).mp3",
        img: "Images/Bounce FM.jpg",
        singer: "Maze"
    },

    {
        name: "Cold Blooded",
        path: "Audio/RicK_James_-_Cold_Blooded_(getmp3.pro).mp3",
        img: "Images/Bounce FM.jpg",
        singer: "Rich James"
    },
    ...
    {
        name: "Running Away",
        path: "Audio/Roy_Ayers_-_Running_Away_12_Versio_(getmp3.pro).mp3",
        img: "Images/Bounce FM.jpg",
        singer: "Roy Ayers"
    },
    ...
    
    {
        ...
        path: "Audio/Ohio_Players-Love_Rollercoaster_St_(getmp3.pro).mp3",
        img:"Images/Bounce FM.jpg",
        singer: "Ohio Players"
    },

    {
        ...
        path:"Audio/Hollywood_Swinging_(getmp3.pro).mp3",
        img: "Images/Bounce FM.jpg",
