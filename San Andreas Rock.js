...
let All_song = [
    {
        name: "Them Bones",
        path: "Audio/Alice_In_Chains_-_Them_Bones_(getmp3.pro).mp3",
        img: "Images/San Andreas Radio.jpg",
        singer: "Alice In Chains"
    },

    {
        name: "Welcome To The Jungle",
        path: "Audio/Gunsn_Roses_-_Welcome_to_the_Jungl_(getmp3.pro).mp3",
        img:  "Images/San Andreas Radio.jpg",
        singer: "GNR"
    },

    {
        name: "Pretend Were Dead",
        path: "Audio/Pretend_Were_Dead_(getmp3.pro).mp3",
        img:  "Images/San Andreas Radio.jpg",
        singer: "L7"
    },
    ...
    {
        name: "Movin On Up",
        path: "Audio/Primal_Scream_-_Movin_on_Up_Lyrics_(getmp3.pro).mp3",
        img:  "Images/San Andreas Radio.jpg",
    ...
    {
        name: "Plush",
        path:"Audio/Stone_Temple_Pilots_-_Plush_(getmp3.pro).mp3",
        img: "Images/San Andreas Radio.jpg",
        singer: "Stone Temple Pilot"
    }
